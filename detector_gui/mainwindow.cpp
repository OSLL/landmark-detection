...
MainWindow::MainWindow(const QString &detectorParamsPath, float focalLength, float objectSize, QWidget *parent) : QMainWindow(parent), fpsCounter(0), staticImageEnabled(false) {
